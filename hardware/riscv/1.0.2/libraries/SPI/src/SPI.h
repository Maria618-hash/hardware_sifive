...
public:
  ...
  inline static void chipselect(uint8_t enable)
	{
		if (enable)
		{
			SPCS = 0xff;
  ...
  inline static uint8_t transfer(uint8_t data) {
   // Serial.print("\n  Transfer start RFEMMMMM");
   // Serial.print(RFEM);
    // Serial.print(READ_Reg(0x80002224 ));
    // Serial.print(READ_Reg(0x80002600 ));
    // Serial.print(READ_Reg(0x80002624 ));SSsssSS

    // Serial.print(READ_Reg(0x80004224 ));
    // Serial.print(READ_Reg(0x80004600 ));
    // Serial.print(READ_Reg(0x80004624 ));
